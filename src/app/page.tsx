...
export default function Home() {
  ...
  return (
    <>
      ...
      <main
        className={`transition-opacity duration-[1000ms] ${isLoaded ? "opacity-100" : "opacity-0"
          }`}
      >
        <section className="bg-linear-to-br from-gray-900 via-black to-gray-900 flex justify-center items-center px-4 py-24">
