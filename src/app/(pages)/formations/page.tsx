                            ...
                            <div className="flex flex-col justify-center space-y-6">
                                <div className="bg-gray-900/40 backdrop-blur-md border border-gray-700/30 rounded-xl p-6 hover:border-blue-500/50 transition duration-300">
                                    <Card title="Apresentação JOIA (Unesp Botucatu)" variant="cyan">
                                        <p>Participei da Apresentação JOIA (Jornada de Integração dos Alunos de Graduação e Pós-graduação), realizada na Unesp Botucatu, representando a turma anterior do curso técnico em Meio Ambiente, onde fui responsável por apresentar o trabalho de conclusão de curso da classe do ano passado.
